...
class XtAPIUserStreamDataSource(UserStreamTrackerDataSource):
    ...
    #     except Exception:
    #         self.logger().network("Unexpected error occured with XT WebSocket Connection")
    #         raise
    #
    ...
    #     """
    #     try:
    #         auth_payload: Dict[str, Any] = self._xt_auth.get_ws_auth_payload(xt_utils.get_ms_timestamp())
    ...
    #     """
    #     try:
    #         # XT WebSocket API currently offers only spot/user/order private channel.
    #         for trading_pair in self._trading_pairs:
    #             params: Dict[str, Any] = {
    #                 "op": "subscribe",
    #                 "args": [f"spot/user/order:{xt_utils.convert_to_exchange_trading_pair(trading_pair)}"]
    #             }
    ...
    #         raise
    #     except Exception:
    #         self.logger().error("Error occured during subscribing to Xt private channels.", exc_info=True)
    #         raise
    #
    ...
    async def listen_for_user_stream(self, ev_loop: asyncio.BaseEventLoop, output: asyncio.Queue):
        ...
        *required
        ...
        #             except Exception:
        #                 self.logger().error(
        #                     "Unexpected error when parsing XT user_stream message. ", exc_info=True
        #                 )
        #                 raise
        #     except asyncio.CancelledError:
        #         raise
        #     except Exception:
        #         self.logger().error(
        #             "Unexpected error with XT WebSocket connection. Retrying after 30 seconds...",
        #             exc_info=True
        #         )
